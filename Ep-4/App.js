...
const RestaurantCard = ({ resData }) => {
    ...
    return (<div className="res-card" style={{ backgroundColor: "#f0f0f0" }} >
        <img className="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId} alt="companyThumbnail" />
        <h3>{name}</h3>
        <h4>{cuisines.join(', ')}</h4>
...
const resList = [
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2024-05-10 15:45:00",
                "opened": true
            },
            "badges": {
